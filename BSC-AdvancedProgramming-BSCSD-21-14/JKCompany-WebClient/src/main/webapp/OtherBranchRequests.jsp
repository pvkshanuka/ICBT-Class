    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active ">
            <a class="nav-link text-danger" href="#">Other Branch Requests</a>
          </li>
 ...
 <%
        ...
        out.print("<div class='container mt-5'>");
            ...
            for(Stockrequest st : stock) {
                ...
                //out.print("<td>" + st.getHeadofficeproductID()+"</td>");
                //out.print("<td>" + st.getBranchID()+"</td>");
              out.print("<td><a href='acceptrequest.jsp?RequestID="+st.getRequestID()+"&Quantity="+st.getQuantity()+"&BranchID="+st.getBranchId()+"&HeadofficeproductID="+st.getHeadofficeproductId()+"'><button class='btn btn-success w-25 p-0'>Accept Request</button></a></td>");
                out.print("</tr>");
