...
<nav class="navbar navbar-expand-lg navbar-light " id="navbar">
 ...
 <div class="d-flex mt-5 " id="wrapper">
    ...
    <div class="bg-light border-right " id="sidebar-wrapper" style="background-color: #333333 !important;">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="Managecustomers.jsp" class="list-group-item list-group-item-action bg-dark sidebar" style="color: #FFFFFF!important;">Manage Customers</a>  
         ...
         <a href="ManageVehicles.jsp" class="list-group-item list-group-item-action bg-dark sidebar" style="color: #D67C6D !important;">Manage Vehciles</a>  
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
          ...
          <div class="col-sm m-5 pb-5 adminform modalBackground" style=" border-radius:30px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.6); border: 3px solid #000;width:50%; padding:30px;"  > <!--aligns padding and margin-->
              
     <form   action="addvehicle.jsp" method="POST" >
                <div class="form-row">
                  <div class="form-group col-md-6">
                    <label for="inputPassword4" class="modalfonts">Vehicle No:</label>
                    <input type="text" class="form-control" id="contactno" name="firstname" placeholder="CAB8088"  value=""> <!--defines the max age for registration-->
                ...
                <div class="form-row">
                <div class="form-group col-md-6">
                <button type="submit" name="submit" value="submit" class="btn btn-success float-right modalfonts"  >Add Vehcile</button>
                </div>
                </diV>
         </form>
    ...
    <%
            List<Vehicle> requests = Webhelper.getallVehicles(user.getBranchID());
          
            
         
        out.print("<div class='container mt-5'>");
            out.print("<table id='' class='display table table-striped table-dark modalfonts'>");
            out.print("<thead><tr><th>Vehicle ID</th><th>Vehicle Number</th></tr></thead>");
            
            out.print("<tbody>");
            for(Vehicle st : requests) {
                out.print("<tr>");
                st.getVehicleID();
                 out.print("<td>" + st.getVehicleID()+"</td>");
                out.print("<td>" + st.getVehicleNo()+"</td>");
                
                 
               
                  out.print("<td><a href='deletvehicle.jsp?vehcleID="+st.getVehicleID()+"'><button class='btn btn-danger w-25 p-0'>Delete</button></a></td>");
