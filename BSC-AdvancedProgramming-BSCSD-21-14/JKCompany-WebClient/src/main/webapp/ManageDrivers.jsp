...
<nav class="navbar navbar-expand-lg navbar-light " id="navbar">
 ...
 <div class="d-flex mt-5 " id="wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="Managecustomers.jsp" class="list-group-item list-group-item-action bg-dark sidebar" style="color: #FFFFFF!important;">Manage Customers</a>  
         <a href="customershopproduct.jsp" class="list-group-item list-group-item-action bg-dark sidebar" style="color:#FFFFFF  !important;">Customer Shop Products</a>  
          ...
          <a href="ManageDrivers.jsp" class="list-group-item list-group-item-action bg-dark sidebar" style="color: #D67C6D !important;">Manage Driver</a>
    ...
    <!-- /#sidebar-wrapper -->
     ...
     <form   action="adddriver.jsp" method="POST" >
              ...
              <div class="form-row">
                ...
                <div class="form-row">
                <div class="form-group col-md-6">
                <button type="submit" name="submit" value="submit" class="btn btn-success float-right"  >Add Driver</button>
                </div>
                </diV>
         </form>
    ...
    <%
            List<Driver> requests = Webhelper.getallDrivers(user.getBranchID());
          
            
         
        out.print("<div class='container mt-5'>");
            out.print("<table id='' class='display table table-striped table-dark modalfonts'>");
            out.print("<thead><tr><th>First Name</th><th>Last Name</th><th>email</th></tr></thead>");
            
            out.print("<tbody>");
            for(Driver st : requests) {
                out.print("<tr>");
                st.getDriverID();
                ...
                out.print("<td>" + st.getLname()+"</td>");
                 out.print("<td>" + st.getEmail()+"</td>");
                  ...
                  out.print("<td><a href='deletdriver.jsp?DriverID="+st.getDriverID()+"'><button class='btn btn-danger w-25 p-0'>Delete</button></a></td>");
