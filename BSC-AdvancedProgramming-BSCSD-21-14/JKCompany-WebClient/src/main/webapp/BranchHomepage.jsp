 ...
 <div class="d-flex mt-5 " id="wrapper">
    ...
    <div class="bg-light border-right " id="sidebar-wrapper" style="background-color: #333333 !important;">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="BranchHomepage.jsp" class="list-group-item list-group-item-action bg-dark font-weight-bold sidebar" style="color: #D67C6D !important;">Manage Account</a>  <!--font weight bold css and etc-->
